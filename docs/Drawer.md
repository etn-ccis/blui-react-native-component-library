...
| hidePadding                   | Whether to hide the padding reserved for DrawerNavItem icons                   | `boolean`                              | no       |                                                                                                   |
...
| nestedDivider                 | Whether to show a dividing line between nested items                           | `boolean`                              | no       | `false`                                                                                           |
| theme                         | Theme value overrides                                                          | `$DeepPartial<ReactNativePaper.Theme>` | no       |                                                                                                   |
