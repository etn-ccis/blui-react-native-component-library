...
describe('Chip component', () => {
  ...
  it('renders correctly with an icon', () => {
    const icon = { family: 'material-community', name: 'star' };
    const tree = TestRenderer.create(<Chip icon={{ family: 'material-community', name: 'chart-pie' }}>Text</Chip>).toJSON();
    expect(tree).toMatchSnapshot();
  });
  ...
  it('renders correctly with both icon and avatar (priority to icon)', () => {
    const icon = { family: 'material-community', name: 'star' };
    const avatar = <Avatar.Text label='AB' />;
    const tree = TestRenderer.create(<Chip icon={{ family: 'material-community', name: 'chart-pie' }} avatar={avatar}>Text</Chip>).toJSON();
    expect(tree).toMatchSnapshot();
  });
