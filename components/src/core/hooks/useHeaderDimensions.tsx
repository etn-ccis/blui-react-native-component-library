...
import { EXTENDED_HEIGHT_LANDSCAPE, EXTENDED_HEIGHT_PORTRAIT, heightWithoutStatusBar, heightWithStatusBar, REGULAR_HEIGHT_LANDSCAPE, REGULAR_HEIGHT_PORTRAIT } from '../header/constants';
