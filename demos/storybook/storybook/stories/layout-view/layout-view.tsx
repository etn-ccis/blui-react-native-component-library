...
const notes = {
    notes:
        'Any React Element may be passed in as `header` or `footer`. ' +
...
storiesOf('LayoutView', module)
    ...
    .add(
        ...
        () => <LayoutView backgroundColor={color('backgroundColor', 'transparent')}>{content}</LayoutView>,
        notes
    )
    .add(
        'with a header and no footer',
        () => (
