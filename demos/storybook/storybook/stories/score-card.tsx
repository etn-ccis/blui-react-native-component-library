...
storiesOf("ScoreCard", module)
    ...
    >
      <View style={{ justifyContent: "center" }}>
        ...
        <ListItem
          containerStyle={{ margin: 0, padding: 0, marginBottom: 8 }}
          leftIcon={
            <MatIcon name={"info"} size={24} color={PXBColors.blue[500]} />
          }
  ...
  .add("with hero badges", () => (
    <ScoreCard
      ...
      badge={
        <HeroBanner
          style={{ flex: 0, minWidth: 180, justifyContent: "flex-end" }}
        >
          {[
            <Hero
              label={"Score"}
            ...
            0,
            number("badges.length", 2, { range: true, min: 0, max: 3, step: 1 })
          )}
        </HeroBanner>
      }
      actionRow={
